...
public:
    void dfs(int node, int parent, vector<int>& subtreeXor, vector<int>& inTime, vector<int>& outTime,
            ...
            // store the xor for all the subtree in the vector
    ...
    //think to check of the ancestor....and get intime and outime from the dfs call
    ...
    int minimumScore(vector<int>& nums, vector<vector<int>>& edges) {
        ...
        //root = 0
        // intime ans outtime to check for the ancestor
